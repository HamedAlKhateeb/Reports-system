      ...
      <div className="mb-6 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div>
          <h1 className="text-2xl font-bold text-slate-900 flex items-center gap-2.5">
            <Kanban className="h-7 w-7 text-teal-600" />
        ...
        <div className="no-print flex items-center gap-2">
          <button
            ...
            className="flex items-center justify-center gap-2 rounded-lg border border-slate-300 bg-white px-3.5 py-2 text-sm font-semibold text-slate-700 shadow-sm hover:bg-slate-50 transition-colors"
          ...
          <button
            ...
            className="flex items-center justify-center gap-2 rounded-lg bg-teal-600 px-4 py-2 text-sm font-semibold text-white shadow hover:bg-teal-700 transition-colors"
          >
      ...
      <div className="no-print mb-6 flex flex-col sm:flex-row gap-3 items-center justify-between">
        ...
        <div className="relative w-full sm:w-80">
          ...
          <input
            ...
            className="w-full rounded-lg border border-slate-300 bg-white ps-10 pe-4 py-2 text-xs text-slate-900 shadow-sm focus:border-teal-500 focus:outline-none focus:ring-1 focus:ring-teal-500"
          />
        </div>
        ...
        <div className="flex items-center gap-2 w-full sm:w-auto">
          ...
          <select
            ...
            className="rounded-lg border border-slate-300 bg-white px-3 py-2 text-xs font-semibold text-slate-700 shadow-sm focus:border-teal-500 focus:outline-none"
          >
          ...
          {columns.map((col) => {
            ...
            return (
              <div
                ...
                className={`flex flex-col rounded-2xl border border-slate-200 border-t-4 bg-slate-100/60 p-4 transition-colors ${
                  col.color
                } ${isDragOver ? 'ring-2 ring-teal-500 bg-teal-50/40' : ''}`}
              >
                {/* Column Header */}
                <div className="mb-4 flex items-center justify-between">
                  ...
                  <span className="rounded-full bg-white px-2 py-0.5 text-xs font-bold text-slate-600 shadow-sm border border-slate-200">
                    {columnIssues.length}
                  </span>
                </div>
